 ...
 */
enum class SalaryRegisterFilterParams(
    override var field: String,
    override var fieldDataProvider: (SalaryRegisterDto) -> Any
) : IFilterParams<SalaryRegisterDto> {
    //1)Salary register
    ...
    // EMPLOYEE_LAST_NAME("employeeLastName",fieldDataProvider = { it.payrolls.lastName!! }),       //1.1
    // EMPLOYEE_NAME("employeeName",fieldDataProvider = {it.payrolls.firstName}),                        //1.2
