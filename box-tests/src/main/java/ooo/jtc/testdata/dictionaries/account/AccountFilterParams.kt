...
enum class AccountFilterParams(
    override var field: String,
    override var fieldDataProvider: (AccountDto) -> Any
) : IFilterParams<AccountDto> {
    ...
    BR_CUST_ID("branchCustomerId", fieldDataProvider = { it.branchCustomerId ?: NON_EXISTENT_ID }),
    BR_CUST_NESTED_ID("branchCustomer.id", fieldDataProvider = { it.branchCustomerId ?: NON_EXISTENT_ID }),
