...
/**
 * Based on https://confluence.jtc.ooo/pages/viewpage.action?pageId=21730460
 */
enum class LetterToBankControls(
    ...
    override val checkEntityName: String = "letterToBank.field",
    ...
    EXECUTION_MESSAGE_EMPTY(
        resultStatus = INVALID,
        groupType = GroupType.EXECUTION_MESSAGE,
        controlType = ControlType.EXECUTION_MESSAGE_NOT_EMPTY,
        checkFieldName = "executionMessage",
        checkMessage = MessageType.STUB
    ),
    EXECUTION_MESSAGE_LENGTH(
        resultStatus = INVALID,
        groupType = GroupType.EXECUTION_MESSAGE,
        controlType = ControlType.EXECUTION_MESSAGE_LENGTH,
        checkFieldName = "executionMessage",
        checkMessage = MessageType.STUB
    ),
    EXECUTION_MESSAGE_AVAILABLE_SYMBOLS(
        resultStatus = INVALID,
        groupType = GroupType.EXECUTION_MESSAGE,
        controlType = ControlType.EXECUTION_MESSAGE_AVAILABLE_SYMBOLS,
        checkFieldName = "executionMessage",
        checkMessage = MessageType.STUB
    ),
    //endregion
