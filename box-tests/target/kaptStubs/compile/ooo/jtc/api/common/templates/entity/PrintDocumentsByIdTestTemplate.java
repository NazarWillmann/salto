...
public class PrintDocumentsByIdTestTemplate<T extends ooo.jtc.interfaces.IDocument> extends ooo.jtc.api.common.tests.AbstractBeTest<java.util.List<? extends T>, kotlin.Unit> {
    ...
    public PrintDocumentsByIdTestTemplate(@org.jetbrains.annotations.NotNull()
