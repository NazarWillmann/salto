...
public class UnblockingTestTemplate<T extends ooo.jtc.interfaces.IEntityDto> extends ooo.jtc.api.common.tests.AbstractTest<T, T> {
    ...
    public UnblockingTestTemplate(@org.jetbrains.annotations.NotNull()
