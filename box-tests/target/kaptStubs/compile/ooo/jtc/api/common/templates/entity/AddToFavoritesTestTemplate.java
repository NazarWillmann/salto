...
public class AddToFavoritesTestTemplate<T extends ooo.jtc.interfaces.IEntityDto> extends ooo.jtc.api.common.tests.AbstractTest<java.util.UUID, java.util.UUID> {
    ...
    public AddToFavoritesTestTemplate(@org.jetbrains.annotations.NotNull()
