...
public final class ControlCode implements ooo.jtc.interfaces.ITransferEntity {
    ...
    @org.jetbrains.annotations.NotNull()
    @java.lang.Override()
    public ooo.jtc.dictionaries.controlcode.ControlCodeDto toDto() {
        return null;
    }
    ...
    public ControlCode(@org.jetbrains.annotations.Nullable()
    ...
    @org.jetbrains.annotations.NotNull()
    public final ooo.jtc.dictionaries.controlcode.ControlCode copy(@org.jetbrains.annotations.Nullable()
    java.util.UUID id, int version, @org.jetbrains.annotations.Nullable()
    java.lang.String code, @org.jetbrains.annotations.Nullable()
    java.lang.String description, @org.jetbrains.annotations.Nullable()
    @com.fasterxml.jackson.annotation.JsonProperty(value = "created_at")
